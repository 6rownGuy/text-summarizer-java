...
public class TextProcessor extends Paragraph {
    ...
    /*  1. This class is the heart of the program.
        2. It extends the paragraph class and declares setParagraph() and countParagraph() methods
        3. It divides the text into paragraphs and stores it in an ArrayList<Paragraph>
        4. It further divides each paragraph into sentences.
        5. The sentences are then sorted according to their scores
        6. They are displayed in the displaySummary() method.
     */
